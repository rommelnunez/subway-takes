            ...
            <div className="relative z-10 w-full h-full flex flex-col justify-center px-16 md:px-24">
                <div className="max-w-2xl space-y-6 mt-16">
                    ...
                    <div className="flex items-center gap-1 mb-2 fade-in">
                        <svg width="60" height="60" viewBox="0 0 412 410" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h1 className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter text-white drop-shadow-2xl leading-[0.85] uppercase">
                        Subway<br />Takes
                    </h1>
                    ...
                    {/* Description */}
                    <p className="text-white text-lg md:text-xl font-medium drop-shadow-lg max-w-xl text-shadow-sm leading-snug">
                    ...
                    <div className="flex items-center gap-4 pt-4">
                        <button
                            onClick={onPlay}
                            className="flex items-center gap-3 bg-white text-black px-8 py-3 rounded-[4px] font-bold text-lg hover:bg-white/90 transition-colors"
                        >
                            <Play className="fill-black w-7 h-7" />
                            Play
                        </button>
                        <a
                            ...
                            className="flex items-center gap-3 bg-[rgba(109,109,110,0.7)] text-white px-8 py-3 rounded-[4px] font-bold text-lg hover:bg-[rgba(109,109,110,0.4)] transition-colors backdrop-blur-md"
                        >
                        ...
                        <div className="absolute right-0 bottom-32 bg-[rgba(51,51,51,0.6)] border-l-2 border-[#dcdcdc] px-4 py-1 flex items-center text-white backdrop-blur-sm">
                            <span className="font-semibold">{showMetadata.maturityRating}</span>
                        </div>
                    </div>
                </div>
            </div>
